    ...
    return (
        ...
        >
            ...
            <header className="w-full max-w-7xl mx-auto flex items-center justify-between shrink-0 mb-8">
                ...
                <nav className="hidden md:flex bg-[#0B2240] rounded-full px-8 py-3 items-center space-x-10 text-xs font-semibold tracking-wide shadow-lg">
                    <a href="#home" className="text-[#FFCC00] hover:text-amber-300 transition-colors">Home</a>
                    <a href="#recruitment" className="text-white/80 hover:text-white transition-colors">Recruitment</a>
                    <a href="#lead-generation" className="text-white/80 hover:text-white transition-colors">Lead Generation</a>
                </nav>
