...
const OfficeAndFooter = () => {
    return (
        <div className="w-full bg-[#031430] text-white  relative overflow-hidden select-none">
            ...
            {/* Topography wavy line design simulation overlay (Matches upper landing frames) */}
          ...
          ========================================================= */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 text-center relative z-10">
                ...
                {/* Video Wrapper Box with absolute circular geometry accents */}
                <div className="relative w-full max-w-4xl mx-auto aspect-[16/9] bg-slate-900/60 rounded-[32px] border border-slate-700/40 shadow-2xl p-2 group">
                    ...
                    <div className="w-full h-full rounded-[24px] bg-black/40 border border-white/5 flex items-center justify-center relative overflow-hidden">
                        ...
                        {/* Centered Play Button Mock Accent to mimic design outline */}
          ...
          ========================================================= */}
            <div className="w-full px-4 sm:px-6 lg:px-8 relative z-20 translate-y-[100px]">
                <div className="max-w-4xl mx-auto bg-[#FFC700] text-[#031430] rounded-[36px] p-8 sm:p-12 text-center shadow-[0_20px_50px_rgba(255,199,0,0.3)] relative overflow-hidden">
                    ...
                    {/* Internal background topography swirl map mask layout */}
          ...
          ========================================================= */}
            <footer className="w-full bg-white text-[#0A1A3A] pt-36 pb-6 px-4 sm:px-6 lg:px-8 rounded-t-[40px] sm:rounded-t-[60px] relative z-10 shadow-[0_-20px_40px_rgba(0,0,0,0.02)]">
                ...
                {/* Subtle interior structural topography vector print line layout */}
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6 pb-12 border-b border-slate-200 relative z-10 text-left">
                    ...
                    {/* Left Column Block: Title Action Segment */}
                    ...
                    {/* Center Column Block: Corporate Contact Markers */}
                    ...
                    {/* Right Column Block: Newsletter Box Form & Social Feeds */}
                    <div className="md:col-span-5 space-y-4">
                        ...
                        {/* Input Subscription Action bar strip */}
                        ...
                        {/* Social Grid Rounded Icons Block */}
                        <div className="flex items-center space-x-2.5 pt-2">
                            {['facebook', 'instagram', 'linkedin', 'twitter'].map((platform, index) => (
                                <a
                                    key={index}
                                    href={`#${platform}`}
                                    className="w-8 h-8 rounded-lg bg-[#FFC700] hover:bg-[#E6B400] text-[#031430] flex items-center justify-center shadow-sm transition-transform duration-200 active:scale-90"
                                    aria-label={`Link to ${platform}`}
                                >
                                    {/* Standard Mini Font Icons Asset replacements mapping dynamically */}
                                    <span className="text-[11px] font-black uppercase tracking-tighter select-none">
