                ...
                {steps.map((step, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* CONTENT BLOCK */}
                            <div className={`lg:col-span-6 flex flex-col space-y-4 order-2 ${isEven ? 'lg:order-2 lg:pl-6' : 'lg:order-1 lg:pr-6'}`}>

                                {/* Step & Title Header Row (Forced to a single un-wrapped line on desktop) */}
                                <div className="flex flex-row items-center flex-nowrap gap-3 sm:gap-4 overflow-visible">
                                    ...
                                    {/* Upscaled Title - Kept on 1 line using whitespace-nowrap */}
                                    <h3 className="text-md sm:text-xl md:text-xl font-black text-[#0A2540] tracking-tight md:whitespace-nowrap ">
                                        {step.title}
                                    </h3>
                                </div>
